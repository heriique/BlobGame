...
// Algorithm-specific
auto NearestNeighboursFlann(flann::Index<flann::L2<double>> &index, const Point2 &p, size_t k) -> PointValueVector;
...
auto SortByAngle(PointValueVector &values, const Point2 &p, double prevAngle) -> PointVector;
auto AddPoint(PointVector &Points, const Point2 &p) -> void;

// General maths
auto PointsEqual(const Point2 &a, const Point2 &b) -> bool;
auto Angle(const Point2 &a, const Point2 &b) -> double;
auto NormaliseAngle(double radians) -> double;
auto PointInPolygon(const Point2 &p, const PointVector &list) -> bool;
auto Intersects(const LineSegment &a, const LineSegment &b) -> bool;

// Point list utilities
auto FindMinYPoint(const PointVector &Points) -> Point2;
...
auto RemovePoint(PointVector &list, const Point2 &p) -> void
{
...
auto SortByAngle(PointValueVector &values, const Point2 &from, double prevAngle) -> PointVector
{
